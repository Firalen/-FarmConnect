        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6">
              Welcome to{' '}
              <span className="text-green-600">FarmConnect</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Connecting Ethiopian farmers directly with buyers. Fresh, local produce delivered to your doorstep. 
              Support sustainable agriculture and enjoy the best quality products.
            </p>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">Direct connection between farmers and consumers</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Fresh from Farm</h3>
              <p className="text-gray-600">Get fresh, organic produce directly from local farmers</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Better prices for both farmers and consumers</p>
            </div>
