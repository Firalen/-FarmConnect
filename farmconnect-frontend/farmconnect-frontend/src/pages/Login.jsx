...
const Login = () => {
  ...
  const handleSocialLogin = (provider) => {
    window.location.href =
      provider === 'google'
        ...
        : `${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/api/users/auth/facebook`;
  };
  ...
  useEffect(() => {
    ...
    if (token) {
      // Save token and redirect (simulate login)
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            ...
            <button onClick={() => handleSocialLogin('facebook')} className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors duration-200">
