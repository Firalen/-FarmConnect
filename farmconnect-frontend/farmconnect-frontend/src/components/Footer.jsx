      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="col-span-1 md:col-span-2">
          ...
          <p className="text-green-100 mb-4 max-w-md">
            Connecting farmers with consumers across Ethiopia. We're committed to sustainable agriculture and supporting local farming communities.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link to="/articles" className="text-green-200 hover:text-white transition-colors duration-200">
                Articles
              </Link>
            </li>
            <li>
              <Link to="/chat" className="text-green-200 hover:text-white transition-colors duration-200">
                Chat Support
              </Link>
            </li>
            <li>
              <Link to="/register" className="text-green-200 hover:text-white transition-colors duration-200">
                Become a Farmer
              </Link>
            </li>
          </ul>
